...
all <- read.csv("data/all_20221122.csv")
...
write.csv(all.random,"data/all_20221122_random200.csv",row.names=FALSE)
...
##############
all.random <- read.csv("data/all_20221122_random200.csv")
